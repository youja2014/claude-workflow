...
같은 날 여러 번 작성하면 `YYYY-MM-DD-<slot>.md` (e.g. `2026-05-17-evening.md`)
...
- memory 의 cross-session 정책과 달리, handoff 는 **시간 순 timeline** 만 담당. 정책성 항목은 ADR 로
